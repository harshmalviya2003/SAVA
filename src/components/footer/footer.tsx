...
const socialLinks = [
  {
    ...
    icon: (
      ...
      >
        <path
          d="M16 8a6 6 0 0 1 6 6v5.5a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 4 19.5V14a6 6 0 0 1 6-6h6z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <rect
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M22 5.92a8.38 8.38 0 0 1-2.36.65A4.13 4.13 0 0 0 21.4 4.1a8.19 8.19 0 0 1-2.6.99A4.1 4.1 0 0 0 11.5 9.03a11.65 11.65 0 0 1-8.45-4.29a4.1 4.1 0 0 0 1.27 5.47A4.07 4.07 0 0 1 2 9.13v.05a4.1 4.1 0 0 0 3.29 4.02a4.09 4.09 0 0 1-1.85.07a4.1 4.1 0 0 0 3.83 2.85A8.23 8.23 0 0 1 2 19.54a11.62 11.62 0 0 0 6.29 1.84c7.55 0 11.68-6.26 11.68-11.68c0-.18-.01-.36-.02-.54A8.18 8.18 0 0 0 22 5.92z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
      </svg>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 flex flex-col md:flex-row md:justify-between gap-12 md:gap-0">
        <div className="flex-1 flex flex-col gap-6 min-w-[220px]">
          <div className="flex items-center gap-2">
            <span className="font-extrabold text-2xl tracking-widest font-mono">
              SAVA
            </span>
          </div>
          <a
            href="mailto:founders@savarobotics.com"
            className="text-lg font-mono text-white/80 hover:text-white transition underline underline-offset-4"
          >
            founders@savarobotics.com
          </a>
        ...
        <div className="flex-1 flex flex-col items-center justify-center min-w-[320px]">
          <h3 className="text-lg font-bold tracking-wider mb-4 text-white">
          ...
          {status === "success" && (
            <div className="text-white mt-2 text-sm">Subscribed!</div>
          )}
          {status === "error" && (
